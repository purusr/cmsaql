...
const createConfiguration = async (datas, bOverride) => {
    ...
    return Configuration.create({
        environment : {
            appUrl          : datas.appUrl,
            currentTheme    : 'web_theme_divisima',
